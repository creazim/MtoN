...
$TCA['tx_nbomn_domain_model_category'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, category_mm, subcategory',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, category_mm, subcategory,--div--;LLL:EXT:cms/locallang_ttc.xml:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'category_mm' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:nbomn/Resources/Private/Language/locallang_db.xml:tx_nbomn_domain_model_category.category_mm',
			/*'config' => array(
				'type' => 'input',
				'size' => 4,
				'eval' => 'int'
			),
			Replace the original config (above) with the config of subcategory:
			*/                                                                 
			'config' => array(
				'type' => 'select',
				'foreign_table' => 'tx_nbomn_domain_model_category',
				...
				/* DONT include the MM_opposite_field option in category_mm!!!
				...
				*/
				...
				'wizards' => array(
					...
					'add' => Array(      
						// add this line to prevent problems with new, unsaved records
						'notNewRecords' => 1,
						'type' => 'script',
						'title' => 'Create new',
						'icon' => 'add.gif',
